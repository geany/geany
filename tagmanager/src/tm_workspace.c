...
static gboolean member_at_method_scope(GPtrArray *tags, const gchar *method_scope, TMTag *member_tag,
	langType lang)
{
	...
	if (len > 1)
	{
		...
		{
			GPtrArray *src = member_tag->file ? member_tag->file->tags_array : tags;
