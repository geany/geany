...
typedef struct TMTag
{
	...
	gboolean plugin_extension;  /**< Whether the tag is generated by a plugin extension */
	gchar *tooltip;  /**< Tooltip to be shown in the symbol tree for plugin extension tags */
	gchar *file_name;  /**< File name in which the plugin extension tag appears */
	TMIcon icon;  /**< Icon shown in the symbol tree for plugin extension tags */
} TMTag;
