...
static void init_general_templates(void)
{
	...
	read_template("gplv3", GEANY_TEMPLATE_GPLV3);
	read_template("gplv2", GEANY_TEMPLATE_GPLV2);
	read_template("agplv3", GEANY_TEMPLATE_AGPLV3);
...
gchar *templates_get_template_licence(GeanyDocument *doc, gint licence_type)
{
	...
	g_return_val_if_fail(licence_type == GEANY_TEMPLATE_GPLV3 || licence_type == GEANY_TEMPLATE_GPLV2 || \
	licence_type == GEANY_TEMPLATE_AGPLV3 || licence_type == GEANY_TEMPLATE_BSD, NULL);
...
static gchar *get_template_fileheader(GeanyFiletype *ft)
{
	...
	templates_replace_valist(template,
		"{gplv3}", templates[GEANY_TEMPLATE_GPLV3],
		"{gplv2}", templates[GEANY_TEMPLATE_GPLV2],
		"{agplv3}", templates[GEANY_TEMPLATE_AGPLV3],
