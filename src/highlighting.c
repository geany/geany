...
static void styleset_docbook_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "sgml_comment", "0x808080", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[19]);
	...
	styleset_get_hex(config, config_home, "styling", "sgml_command", "0x991111", "0xffffff", "true", types[GEANY_FILETYPES_DOCBOOK]->styling[21]);
	styleset_get_hex(config, config_home, "styling", "sgml_doublestring", "0x1E90FF", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[22]);
	styleset_get_hex(config, config_home, "styling", "sgml_simplestring", "0x004040", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[23]);
	styleset_get_hex(config, config_home, "styling", "sgml_1st_param", "0x804040", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[24]);
	styleset_get_hex(config, config_home, "styling", "sgml_entity", "0x101030", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[25]);
	styleset_get_hex(config, config_home, "styling", "sgml_block_default", "0x100000", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[26]);
	styleset_get_hex(config, config_home, "styling", "sgml_1st_param_comment", "0x906040", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[27]);
	styleset_get_hex(config, config_home, "styling", "sgml_error", "0x0000ff", "0xffffff", "false", types[GEANY_FILETYPES_DOCBOOK]->styling[28]);
...
static void styleset_conf_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "default", "0x00007f", "0xffffff", "false", types[GEANY_FILETYPES_CONF]->styling[0]);
	styleset_get_hex(config, config_home, "styling", "comment", "0x808080", "0xffffff", "false", types[GEANY_FILETYPES_CONF]->styling[1]);
	styleset_get_hex(config, config_home, "styling", "section", "0x900000", "0xffffff", "true", types[GEANY_FILETYPES_CONF]->styling[2]);
	styleset_get_hex(config, config_home, "styling", "key", "0x7f0000", "0xffffff", "false", types[GEANY_FILETYPES_CONF]->styling[3]);
	styleset_get_hex(config, config_home, "styling", "assignment", "0x000000", "0xffffff", "false", types[GEANY_FILETYPES_CONF]->styling[4]);
	styleset_get_hex(config, config_home, "styling", "defval", "0x7f0000", "0xffffff", "false", types[GEANY_FILETYPES_CONF]->styling[5]);
...
static void styleset_asm_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "string", "0x1E90FF", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[3]);
	styleset_get_hex(config, config_home, "styling", "operator", "0x000000", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[4]);
	styleset_get_hex(config, config_home, "styling", "identifier", "0x000088", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[5]);
	styleset_get_hex(config, config_home, "styling", "cpuinstruction", "0x991111", "0xffffff", "true", types[GEANY_FILETYPES_ASM]->styling[6]);
	styleset_get_hex(config, config_home, "styling", "mathinstruction", "0x00007F", "0xffffff", "true", types[GEANY_FILETYPES_ASM]->styling[7]);
	styleset_get_hex(config, config_home, "styling", "register", "0x100000", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[8]);
	styleset_get_hex(config, config_home, "styling", "directive", "0x0F673D", "0xffffff", "true", types[GEANY_FILETYPES_ASM]->styling[9]);
	styleset_get_hex(config, config_home, "styling", "directiveoperand", "0x1E90FF", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[10]);
	styleset_get_hex(config, config_home, "styling", "commentblock", "0x808080", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[11]);
	styleset_get_hex(config, config_home, "styling", "character", "0x1E90FF", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[12]);
	styleset_get_hex(config, config_home, "styling", "stringeol", "0x000000", "0xe0c0e0", "false", types[GEANY_FILETYPES_ASM]->styling[13]);
	styleset_get_hex(config, config_home, "styling", "extinstruction", "0x7F7F00", "0xffffff", "false", types[GEANY_FILETYPES_ASM]->styling[14]);
...
static void styleset_sql_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "number", "0x007f7f", "0xffffff", "false", types[GEANY_FILETYPES_SQL]->styling[4]);
	styleset_get_hex(config, config_home, "styling", "word", "0x7f1a00", "0xffffff", "true", types[GEANY_FILETYPES_SQL]->styling[5]);
	styleset_get_hex(config, config_home, "styling", "word2", "0x00007f", "0xffffff", "true", types[GEANY_FILETYPES_SQL]->styling[6]);
	...
	styleset_get_hex(config, config_home, "styling", "identifier", "0x991111", "0xffffff", "false", types[GEANY_FILETYPES_SQL]->styling[10]);
	...
	styleset_get_hex(config, config_home, "styling", "quotedidentifier", "0x991111", "0xffffff", "false", types[GEANY_FILETYPES_SQL]->styling[14]);
...
static void styleset_caml_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "number", "0x007f7f", "0xffffff", "false", types[GEANY_FILETYPES_CAML]->styling[5]);
	styleset_get_hex(config, config_home, "styling", "keyword", "0x7f1a00", "0xffffff", "true", types[GEANY_FILETYPES_CAML]->styling[6]);
	styleset_get_hex(config, config_home, "styling", "keyword2", "0x00007f", "0xffffff", "true", types[GEANY_FILETYPES_CAML]->styling[7]);
	...
	styleset_get_hex(config, config_home, "styling", "identifier", "0x991111", "0xffffff", "false", types[GEANY_FILETYPES_CAML]->styling[11]);
...
static void styleset_oms_init(void)
{
	...
	styleset_get_hex(config, config_home, "styling", "word", "0x111199", "0xffffff", "false", types[GEANY_FILETYPES_OMS]->styling[3]);
	styleset_get_hex(config, config_home, "styling", "string", "0x1e90ff", "0xffffff", "false", types[GEANY_FILETYPES_OMS]->styling[4]);
	styleset_get_hex(config, config_home, "styling", "character", "0x004040", "0xffffff", "false", types[GEANY_FILETYPES_OMS]->styling[5]);
	...
	styleset_get_hex(config, config_home, "styling", "param", "0x111199", "0x0000ff", "false", types[GEANY_FILETYPES_OMS]->styling[9]);
	styleset_get_hex(config, config_home, "styling", "scalar", "0xff0000", "0xffffff", "false", types[GEANY_FILETYPES_OMS]->styling[10]);
