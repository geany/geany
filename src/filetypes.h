...
typedef enum
{
	...
	GEANY_FILETYPE_GROUP_OTHER,
	GEANY_FILETYPE_GROUP_A_B,
	GEANY_FILETYPE_GROUP_C,
	GEANY_FILETYPE_GROUP_D_E_F,
	GEANY_FILETYPE_GROUP_G_H_I,
	GEANY_FILETYPE_GROUP_J_K_L,
	GEANY_FILETYPE_GROUP_M_N_O,
	GEANY_FILETYPE_GROUP_P_Q,
	GEANY_FILETYPE_GROUP_R_S,
	GEANY_FILETYPE_GROUP_T_U_V_W,
	GEANY_FILETYPE_GROUP_X_Y_Z,
