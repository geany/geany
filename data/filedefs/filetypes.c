...
primary=asm auto break case const continue default do else enum extern for goto if inline register restrict return sizeof static struct switch typedef union volatile while _Alignas _Alignof _Atomic _Complex _Generic _Imaginary _Noreturn _Static_assert _Thread_local FALSE NULL TRUE

secondary=char double float int long short signed unsigned void _Bool
